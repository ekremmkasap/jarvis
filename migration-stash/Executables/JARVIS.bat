...
set "JARVIS_WEB_ONLY=0"
set "JARVIS_OPEN_MIC=1"
...
echo.
echo  ================================================
echo   JARVIS - DESKTOP CANONICAL LAUNCHER
echo  ================================================
echo   Mod      : Full Stack Only
echo   Repo     : %REPO%
echo   Vault    : %OBSIDIAN_VAULT_PATH%
echo   AutoOpen : %JARVIS_OBSIDIAN_AUTO_OPEN%
echo   Voice    : %JARVIS_VOICE_RUNTIME%
echo   Mic      : Acik mikrofon aktif
echo   Hologram : %JARVIS_ENABLE_HOLOGRAM%
echo   Telegram : aktif kalacak ^(web-only kapali^)
echo  ================================================
echo.
